  ...
  return (
    <DashboardLayout>
      <div className="flex flex-col h-full w-full max-w-2xl">
        <h1 className={`text-3xl font-bold mb-8 ${resolvedTheme === 'dark' ? 'text-white' : 'text-gray-900'}`}>Settings</h1>
        ...
        >
          <h2 className={`text-lg font-semibold mb-4 flex items-center gap-2 ${resolvedTheme === 'dark' ? 'text-white' : 'text-gray-900'}`}>
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className={`text-sm font-medium ${resolvedTheme === 'dark' ? 'text-gray-200' : 'text-gray-700'}`}>
                  Voice Responses
                </p>
              ...
              <button
                ...
                className={`relative w-11 h-6 rounded-full transition-colors ${
                  voiceSettings.voiceEnabled ? 'bg-blue-600' : resolvedTheme === 'dark' ? 'bg-gray-600' : 'bg-gray-300'
                }`}
              >
                <span
            ...
            <div>
              ...
              />
              <div className={`flex justify-between text-xs mt-1 ${resolvedTheme === 'dark' ? 'text-gray-500' : 'text-gray-400'}`}>
                <span>0.5x</span>
                <span>1.0x</span>
                <span>2.0x</span>
              </div>
            ...
            {/* Voice Selector */}
            <div>
              <p className={`text-sm font-medium mb-2 ${resolvedTheme === 'dark' ? 'text-gray-200' : 'text-gray-700'}`}>
                Voice
              </p>
              <select
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative w-11 h-6 rounded-full transition-colors ${
                  voiceSettings.handsFreeMode ? 'bg-blue-600' : resolvedTheme === 'dark' ? 'bg-gray-600' : 'bg-gray-300'
                }`}
              >
                <span
                  className={`absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full transition-transform ${
