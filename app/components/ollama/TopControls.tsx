                ...
                <HoverCard key={model.model}>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center space-x-3 mt-1">
                            ...
                            <span
                              className={`text-xs font-medium ${theme === 'dark' ? 'text-blue-300' : 'text-blue-700'}`}
                            >
                              {model.specialty}
                            </span>
                          </div>
                  ...
                  <HoverCardContent
                    className={`w-80 border ${
                      theme === 'dark' ? 'bg-card border-border' : 'bg-white border-gray-200 shadow-lg'
                    }`}
                  >
                    <div className="space-y-3">
                      <h4 className={`font-semibold ${theme === 'dark' ? 'text-foreground' : 'text-gray-900'}`}>
                        {model.name}
                      </h4>
                      <p
                      ...
                      <div
                        className={`flex justify-between text-xs pt-2 border-t ${
                          theme === 'dark' ? 'text-muted-foreground border-border' : 'text-gray-500 border-gray-200'
                        }`}
                      >
