    ...
    <div className="text-center mb-6">
      <div className="flex items-center justify-center space-x-4 mb-4">
        <div className="flex items-center space-x-2">
          <Cpu className={`w-10 h-10 ${resolvedTheme === 'dark' ? 'text-blue-400' : 'text-blue-600'}`} />
        </div>
      ...
      <div className="flex justify-center space-x-6 mt-4 text-sm">
        <div className={`flex items-center space-x-2 ${resolvedTheme === 'dark' ? 'text-blue-300' : 'text-blue-500'}`}>
          <FileText className="w-4 h-4" />
          <span>Document Processing</span>
        </div>
        <div className={`flex items-center space-x-2 ${resolvedTheme === 'dark' ? 'text-green-300' : 'text-green-500'}`}>
