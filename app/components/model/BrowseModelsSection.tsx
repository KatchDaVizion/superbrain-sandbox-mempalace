...
export const BrowseModelsSection: React.FC<BrowseModelsSectionProps> = ({
  ...
  return (
    <div>
      ...
      {browseLoading && (
        <p className={`text-center ${resolvedTheme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>
          Loading models...
        </p>
      )}
      
      {browseError && (
        <p className={`text-center ${resolvedTheme === 'dark' ? 'text-red-400' : 'text-red-600'}`}>
      ...
      {textModels.length === 0 && embeddingModels.length === 0 && (
        <div className={`text-center py-8 ${resolvedTheme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>
