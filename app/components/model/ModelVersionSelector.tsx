                  ...
                  className={`flex flex-col gap-2 p-3 rounded-lg cursor-pointer transition-all duration-200 ${
                    isSelected
                      ...
                      : `border border-transparent ${
                          theme === 'dark' ? 'hover:bg-blue-900/30' : 'hover:bg-gray-50'
                        }`
                  }`}
                >
                  ...
                  <div className="flex flex-wrap gap-2 text-xs">
                    ...
                    {version.estimatedRAMGB && (
                      ...
                      >
                        <Cpu className={`h-3 w-3 ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`} />
                    ...
                    {version.gpu && (
                      <div className={`flex items-center space-x-1 px-2 py-1 rounded ${
                        ...
                        <Zap className={`h-3 w-3 ${theme === 'dark' ? 'text-emerald-400' : 'text-emerald-600'}`} />
